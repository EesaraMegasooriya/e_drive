        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3.5 sm:px-6">
          ...
          <div className="flex min-w-0 items-center gap-2.5">
            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-blue-600 shadow-sm">
              <HardDrive className="text-white" size={18} strokeWidth={2.25} />
            </span>
          ...
          <div className="flex shrink-0 items-center gap-3">
            ...
            <Link to="/profile" aria-label="Profile settings" title="Profile settings" className="rounded-lg p-2 text-slate-600 transition hover:bg-slate-100 hover:text-slate-900">
              <Settings size={16} />
            </Link>
            {user?.role === "ADMIN" && <Link to="/admin" aria-label="Admin panel" title="Admin panel" className="rounded-lg p-2 text-slate-600 transition hover:bg-slate-100 hover:text-slate-900"><ShieldCheck size={16} /></Link>}
